      ...
      <section>
        ...
        <form onSubmit={onUpdate} style={formStyles}>
          <div style={formControlStyles}>
            ...
            <input type="email" name="email" id="email" placeholder="user@company.io" value={formState.email} onChange={(e: React.ReactInputEvent) => onChange(e)} />
          </div>
          <div style={formControlStyles}>
            <label htmlFor="password">패스워드</label>
            <input type="password" name="password" id="password" placeholder="영어, 숫자 조합 6자리 이상" value={formState.password} onChange={(e: React.ReactInputEvent) => onChange(e)} />
          </div>
      ...
      <section>
        ...
        <form onSubmit={onUpdate} style={formStyles}>
          <div style={formControlStyles}>
            ...
            <input type="email" name="email" id="hoc-email" placeholder="user@company.io" value={formState.email} onChange={(e: React.ReactInputEvent) => onChange(e)} />
          </div>
          <div style={formControlStyles}>
            <label htmlFor="hoc-password">패스워드</label>
            <input type="password" name="password" id="hoc-password" placeholder="영어, 숫자 조합 6자리 이상" value={formState.password} onChange={(e: React.ReactInputEvent) => onChange(e)} />
          </div>
          <button type="submit">제출</button>
        </form>
        {children}
